...
<head>
    ...
    <?php include_once ("recursos/crearTabla.php"); ?>
...
<main>
    ...
    <form method="post"  enctype="multipart/form-data" action="recursos/buscador.php">
    ...
    if (isset($_SESSION["usuario"]) && $_SESSION["estado"]==1) {
        ...
        echo "<a href='recursos/agregarPokemon.php' class='btn btn-dark mt-3'>Agregar Pokemon</a>";
